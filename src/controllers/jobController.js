...
// @desc Get a job
// @route GET /api/job/specific
// @access public

const getSpecificRecruiterJob = async (req, res) => {
    try {
...
module.exports = { createJob, updateJob, deleteJob, getAllJobs, getSpecificRecruiterJob, getSingleJob };